...
OPENAI_CHAT_INSTRUCTIONS = os.environ.get(
    ...
    "Keep responses very short by default: usually 1 to 2 short sentences, or one very short paragraph only when needed. "
    "Give the direct answer first. "
    "Only add one brief useful follow-up detail when it truly helps. "
